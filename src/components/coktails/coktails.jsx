    ...
    <div>
      {data.map(
        ({
          ...
          return (
            <div key={idDrink} className="coktail-container">
              <div className="small-container">
                <div className="image-container">
                  <div className="titles">{strDrink}</div>
                  <img className="coktails-image" alt="coctail" src={strDrinkThumb}></img>
                </div>
                <div className="ingredients-container">
                  ...
                  <div className="ingredients">
                    ...
                    {ingredients.map((ingredient) => {
                      if (ingredient !== null) {
                        return (
                          <div className="coktail-signature" key={ingredient}>
                          <img
                            alt="ingredients"
